...
export const SvgDelete = ({ fill }: { fill?: string }) => (
  <svg
    width="10"
    height="12"
    viewBox="0 0 10 12"
...
export const SvgFilter3Line = ({ className, onClick }) => {
  return (
    <svg
      onClick={onClick}
      className={clsx(` h-[24px] w-[24px] cursor-pointer `, className)}
      width="24"
      height="24"
      viewBox="0 0 24 24"
      fill="currentColor"
