          ...
          <>
            ...
            <div className="flex gap-x-[10px] sm:gap-x-[12px] xl:gap-x-[24px] overflow-x-auto pb-1 justify-center ">
              {[
                {
                  label: 'Sessions',
                  value: trainingInTotalStatistics?.sessions || 0,
                },
                {
                  label: 'Hours',
                  value: trainingInTotalStatistics?.hours || 0,
                },
                {
                  label: 'Technic',
                  value:
                    trainingInTotalStatistics?.trainingCategory?.technical || 0,
                },
                {
                  label: 'Tactic',
                  value:
                    trainingInTotalStatistics?.trainingCategory?.tactics || 0,
                },
                {
                  label: 'Physic',
                  value:
                    trainingInTotalStatistics?.trainingCategory?.physical || 0,
                },
                {
                  label: 'Mental',
                  value:
                    trainingInTotalStatistics?.trainingCategory?.mental || 0,
                },
              ].map((o, index) => (
                <Match key={index} title={o.label} value={o.value} />
              ))}
