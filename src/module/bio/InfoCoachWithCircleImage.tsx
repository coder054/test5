    ...
    <>
      ...
      <div className="w-[316px]  mx-auto flex justify-center gap-x-[24px] mb-[24px] ">
        <div className=" flex flex-col justify-between">
          <div className="h-[45px] mb-[10px]">
            <div className="text-white text-[14px] font-semibold leading-[24px] text-right whitespace-nowrap">
              {dataBio?.position}
            </div>
          ...
          <div className="h-[45px] mb-[10px]">
            <div className="text-white text-[18px] leading-[24px] text-right whitespace-nowrap ">
              <span className="inline-block mr-[2px] ">UEFA A</span>
            </div>
            <div className="text-Grey text-[12px] leading-[20px] font-bold text-right ">
              EDUCATION
            </div>
        ...
        <div className=" flex flex-col justify-between">
          <div className="h-[45px] ">
            <div className="text-white text-[14px] font-semibold leading-[24px] text-left h-[24px] ">
              {dataBio?.age}
            </div>
      ...
      {!signupForm && dataBio?.userId !== currentRoleId && authenticated && (
        <div className="max-w-[466px] mx-auto mb-[24px] grid grid-cols-2 gap-x-[26px] ">
          {/* // here coach button friend render */}
          <FriendButton
