...
import { editGroup, editMember } from 'src/service/contacts/group.service'

interface EditMembersModalProps {
  isClose: (value: string) => void
}

export default function EditMembers({ isClose }: EditMembersModalProps) {
  ...
  const onSubmit = useCallback(() => {
    mutateEdit({ data: { memberIds: members, memberType: 'MEMBER' }, groupId })
