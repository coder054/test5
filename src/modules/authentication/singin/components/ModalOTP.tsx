  ...
  return (
    ...
    >
      <form
        ...
        className="flex flex-col items-center justify-center space-y-6 mobileM:h-screen mobileM:w-screen tabletM:w-[500px] tabletM:h-auto tabletM:p-8 mobileM:p-6"
      >
        ...
        <p className="font-Roboto text-base ">
          Now verify your mobile phone number by adding the 6 digit code we sent
          to {phone && '+' + phone}{' '}
          <button
            type="button"
